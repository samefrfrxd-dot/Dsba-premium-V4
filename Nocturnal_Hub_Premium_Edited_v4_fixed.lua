...
task.spawn(function()
	...
	TS:Create(IntroAvatar,FadeInfo,{
		ImageTransparency = 1,
...
local BottomAvatar = Instance.new("ImageLabel", Main)
BottomAvatar.Size = UDim2.fromOffset(42,42)
BottomAvatar.Position = UDim2.new(1,-55,1,-52)
BottomAvatar.BackgroundColor3 = Color3.fromRGB(20,20,25)
BottomAvatar.BorderSizePixel = 0
pcall(function()
